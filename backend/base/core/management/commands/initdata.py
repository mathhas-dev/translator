    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            try:
                ...
                sequence = UserSequence.objects.create(sequence=10006)
                user_student = service.create_user(
                    sequence.sequence, 'User 1', 'student@student.com', 'admin123')

                sequence = UserSequence.objects.create(sequence=10007)
                user_student_2 = service.create_user(
                    sequence.sequence, 'User 2', 'student2@student.com', 'admin123')
        ...
        os.system(
            f"python manage.py set_enablement {user_student.username} user_user")
        os.system(
            f"python manage.py set_enablement {user_student_2.username} user_user")
...
# ____________________Métodos_auxiliares_______________________
    ...
    # Será utilizado para setar permissões globais por profile "e acima"
    management_profiles = [
        {
